...
DX Cancri alien relics — contraband, watch for customs). Price = base × (0.5 + 0.13 × ly from
source) × a weekly deterministic wobble; stock is deep near the source and thin far away.
